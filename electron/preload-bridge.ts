...
export const SHIGUANG_BRIDGE_METHODS = [
  ...
  "pickAttachments", "sendUserMessage", "getRunEvents", "listPendingApprovals", "listReusableApprovals", "revokeApprovalScope", "listWorkspaceMemories", "forgetWorkspaceMemory", "markWorkspaceMemoryStale", "listMemoryCandidates", "acceptMemoryCandidate", "dismissMemoryCandidate", "decideApproval",
